  ...
  return (
    <div className='shadow-sm border-b sticky top-0 z-50'  >
      <div className="flex justify-between max-w-6xl mx-5 lg:mx-auto items-centre " >
        ...
        <div  onClick={() => router.push("./")} className="relative w-20 h-20 lg:hidden cursor-pointer rounded-md ">
          <Image 
        ...
        <div className='flex space-x-4 items-center justify-end'>
          ...
          {session ? (
            <>
              ...
              <svg onClick={() => setIsOpen(true)}   xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 cursor-pointer  ">
