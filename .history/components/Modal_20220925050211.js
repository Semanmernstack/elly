...
function Modal() {
  ...
  <Transition show={open} as={Fragment}>
    <Dialog as="div" className="fixed z-10 inset-0 justify-centre items-center overflow-y-auto" onClose={() => setOpen(false)}>
     ...
     <div className='flex items-end  justify-centre min-h-[800px] sm:min-h-screen pt-4 px-4 pb-20 text-centre' >
      <Transition.Child
        ...
        leaveTo="opacity-0"
      >
        <Dialog.Overlay className="fixed text-blue-500 align-centre justify-center inset-0 bg-black-500 transition-opacity    " />
      </Transition.Child>
