...
function Post({ id, userImg, username, caption, img }) {
  ...
  return (
    <div className='bg-white my-7 border rounded-md '  >
        ...
        {comments.lenght > 0 && (  
            <div className="overflow-y-scroll ml-10 h-20 scrollbar-thumb-black  " >
            {comments.map((comment) => (  
                <div key={comment.id} className="items-centre flex space-x-2 mb-4" >
                    <img className='h-7' src={comment.data().image} alt="" />
